...
> Paste-ready artifact entry for the AIML-500 professional portfolio. Fill in the two
> placeholders — `{{VIDEO_LINK}}` (your demo recording) and the live-demo URL once the
> Hugging Face Space is up — then drop this into your portfolio site (Google Sites / Wix /
> GitHub Pages). Keep the **Reflection** out of the public site; submit it to Brightspace.
...
## Demo & Source
- **Live demo (text mode, free):** {{DEMO_URL}}
